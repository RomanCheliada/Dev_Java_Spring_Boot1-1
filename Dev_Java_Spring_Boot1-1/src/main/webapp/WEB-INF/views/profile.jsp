...
<sec:authorize access="hasRole('ROLE_TRANSPORTER')">
	...
	<div class="row">
		<div class="col-4">
			...
			<h4 class="text-center"><a class="btn btn-outline-warning btn-lg">Change information</a></h4>
		</div>
		<div class="col-4">
			...
			<h4 class="text-center"><a class="btn btn-outline-warning btn-lg">Change password</a></h4>
		</div>
		<div class="col-4">
			...
			<c:choose>
				<c:when test="${transporter.status=='IN_THE_WAY'}"><h4  class="text-center"><a href="/profile/changeStatus" class="btn btn-outline-danger btn-lg ">IN_THE_WAY</a></h4></c:when>
				<c:otherwise><h4 class="text-center"><a href="/profile/changeStatus" class="btn btn-outline-success btn-lg">FREE</a></h4></c:otherwise>
			</c:choose>
		</div>
	</div>
</div>
...
<sec:authorize access="hasRole('ROLE_OWNER')">
	<div class="container">
		<div class="row">
			...
			<h4  class="text-center">Phone:</h4><br>
			<h4  class="text-center">Count:</h4><br>
			<h4  class="text-center">Address:</h4><br>
			<h4 class="text-center"><a class="btn btn-outline-warning btn-lg">Change information</a></h4>
		</div>
		<div class="col-6">
			<h4 style="margin-top:15px;" class="text-center">${owner.name}</h4><br>
			<h4 class="text-center">${owner.phone}</h4><br>
			<h4 class="text-center">${owner.count}</h4><br>
			<h4 class="text-center">${owner.address}</h4><br>
			<h4 class="text-center"><a class="btn btn-outline-warning btn-lg">Change password</a></h4>
		</div>
		</div>
		<div class="row">
