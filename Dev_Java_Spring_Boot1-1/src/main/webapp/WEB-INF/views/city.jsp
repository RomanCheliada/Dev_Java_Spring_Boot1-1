...
<div class="row">
				...
				<form:form action="/admin/city" method="POST" modelAttribute="city">
					...
					<div class="form-group row" style="margin-top:5px;">
						...
						<div class="col-2 offset-sm-2">
        					...
        					<a href="/admin/city/cancel<custom:allParams/>" class="btn btn-outline-warning ">Cancel</a>
      					</div>
					</div>
		...
		<div class="row">
		<div class="col-8">
 				<form:form modelAttribute="filter" action="/admin/city" method="GET">
 					<div class="form-group row">
 						<div class="col-12">
 			...
 			<div class="col-2 text-center">
 			<custom:size posibleSizes="1,2,5,10" size="${citys.size}" />
 			</div>
  		</div>
		<div class="row">
			<div class="col-12">
				...
				<thead>
					...
					<c:forEach var="city" items="${citys.content}">
					<tbody>
						<tr>
							<td class="text-center">${city.name}</td>
							<td class="text-center">
								<a href="/admin/city/update/${city.id}<custom:allParams/>" class="btn btn-outline-warning btn-sm">Update</a>
								<a href="/admin/city/delete/${city.id}<custom:allParams/>" class="btn btn-outline-danger btn-sm">Delete</a>
							</td>
						</tr>
						</tbody>
					</c:forEach>
